...
export const EXCHANGES = [
  {
    ...
    referralUrl: 'https://www.bybit.com/en?ref=RML3W',
  },
  {
    id: 'bitget',
    name: 'Bitget',
    ...
    referralUrl: 'https://www.bitget.com/asia/referral/register?clacCode=AK0H5Z9B&from=%2Fasia%2Fevents%2Freferral-all-program&source=events&utmSource=PremierInviter',
  },
  {
    id: 'okx',
    name: 'OKX',
    ...
    cardBg: 'bg-gray-50',
    description: '수수료 50% 페이백',
    referralUrl: 'https://okx.com/join/40463468',
  },
  {
    id: 'mexc',
    name: 'MEXC',
    ...
    cardBg: 'bg-orange-50',
    description: '수수료 50% 페이백',
    referralUrl: 'https://promote.mexc.com/r/eQis7YR1',
  },
  // {
  //   id: 'bingx',
  //   name: 'BingX',
  ...
  // },
  {
    ...
    identityVerificationGuideImage: '/exchanges/binance/binance_identity_verification_guide.png',
    documentVerificationGuideImage: '/exchanges/binance/binance_document_verification_guide.png',
    idDocumentUploadGuideImage: '/exchanges/binance/binance_id_document_upload_guide.png',
    paybackRate: 40,
    makerFee: 0.012,
    takerFee: 0.03,
    logoBg: 'bg-amber-100',
